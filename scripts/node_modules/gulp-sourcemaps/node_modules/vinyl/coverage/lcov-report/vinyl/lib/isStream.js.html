...
<div class="header high">
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">vinyl/lib/</a> &#187;
        isStream.js
    </div>
</div>
<div class="body">
<pre><table class="coverage">
    <tr>
        ...
        <td class="text"><pre class="prettyprint lang-js">var Stream = require('stream').Stream;
&nbsp;
